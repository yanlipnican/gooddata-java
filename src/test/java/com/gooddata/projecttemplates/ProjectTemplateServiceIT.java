...
public class ProjectTemplateServiceIT extends AbstractGoodDataIT {
    ...
    public void setUp() throws Exception {
        template = readObjectFromResource("/projecttemplates/template.json", Template.class);
    }
    ...
    public void shouldGetTemplate() throws Exception {
        ...
        final Template template = gd.getProjectTemplateService().getTemplate(TEMPLATE_URI);
    ...
    public void shouldGetTemplates() throws Exception {
        onRequest()
                ...
                .respond()
                .withBody(readFromResource("/projecttemplates/templates.json"))
                .withStatus(200);
    ...
    public void shouldGetManifests() throws Exception {
        ...
        final Collection<DatasetManifest> manifests = gd.getProjectTemplateService().getManifests(TEMPLATE_URI);
    ...
    private static void onTemplateRequest() {
        onRequest()
                ...
                .respond()
                .withBody(readFromResource("/projecttemplates/template.json"))
                .withStatus(200);
    }
}