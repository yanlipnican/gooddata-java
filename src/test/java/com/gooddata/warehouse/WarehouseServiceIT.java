...
public class WarehouseServiceIT extends AbstractGoodDataIT {
    ...
    @Test(expectedExceptions = GoodDataException.class, expectedExceptionsMessageRegExp = ".*Unable to add S3 credentials in warehouse, uri: /gdc/datawarehouse/instances/instanceId/s3/region/accessKey$")
    ...
    @Test(expectedExceptions = GoodDataException.class, expectedExceptionsMessageRegExp = ".*Unable to POST S3 credentials /gdc/datawarehouse/instances/instanceId/s3/region/accessKey")
    ...
    @Test(expectedExceptions = GoodDataException.class, expectedExceptionsMessageRegExp = ".*Attempt to add S3 credentials in warehouse failed, can't get the result, uri: /gdc/datawarehouse/instances/instanceId/s3$")
    ...
    @Test(expectedExceptions = GoodDataException.class, expectedExceptionsMessageRegExp = ".*Unable to update S3 credentials in warehouse, uri: /gdc/datawarehouse/instances/instanceId/s3/region/accessKey$")
    ...
    @Test(expectedExceptions = GoodDataException.class, expectedExceptionsMessageRegExp = ".*Unable to PUT S3 credentials /gdc/datawarehouse/instances/instanceId/s3/region/accessKey")
    ...
    @Test(expectedExceptions = GoodDataException.class, expectedExceptionsMessageRegExp = ".*Attempt to update S3 credentials in warehouse failed, can't get the result, uri: /gdc/datawarehouse/instances/instanceId/s3$")
    ...
    @Test(expectedExceptions = GoodDataException.class, expectedExceptionsMessageRegExp = ".*Unable to delete S3 credentials in warehouse, uri: /gdc/datawarehouse/instances/instanceId/s3/region/accessKey$")
    ...
    @Test(expectedExceptions = GoodDataException.class, expectedExceptionsMessageRegExp = ".*Unable to DELETE S3 credentials /gdc/datawarehouse/instances/instanceId/s3/region/accessKey")
    ...
    @Test(expectedExceptions = GoodDataException.class, expectedExceptionsMessageRegExp = ".*Attempt to delete S3 credentials in warehouse failed, can't get the result, uri: /gdc/datawarehouse/instances/instanceId/s3$")
